...
<div class="w-full flex items-center flex-col px-4">
	<form
		class="m-2 mx-4 flex max-w-prose gap-2 shadow w-full align-middle bg-stone-50 items-center border-stone-300 border-2 p-1 rounded-lg focus-within:shadow-lg focus-within:border-stone-400 transition-all dark:bg-stone-800 dark:border-stone-700"
	>
		<textarea
			tabindex="9999"
